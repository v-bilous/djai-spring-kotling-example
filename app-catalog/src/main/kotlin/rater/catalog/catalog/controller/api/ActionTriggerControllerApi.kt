...
@Api(value = "ActionTriggerController", tags = ["ActionTriggerController"], description = "the ActionTriggerController API")
interface ActionTriggerControllerApi {

	@ApiOperation(value = "getAll", nickname = "getAllUsingGET1", notes = "", tags=["action-trigger-controller"])
	@ApiResponses(
	...
	fun getAllUsingGET1(
			...
			@PageableDefault(value=0, size = 50, sort=["id"], direction = Sort.Direction.ASC) page: Pageable): ResponseEntity<Page<ActionTrigger>> {
