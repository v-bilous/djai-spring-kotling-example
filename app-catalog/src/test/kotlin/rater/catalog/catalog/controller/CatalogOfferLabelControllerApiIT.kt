...
class CatalogOfferLabelControllerApiIT : AbstractIntegrationTest<CatalogOfferLabel>() {

	private val url = "/offer-labels"

	@Autowired
	lateinit var repository: CatalogOfferLabelControllerRepository

	@Test
	fun `deleteAllUsingDELETE13 api`() {
	...
	@Test
	fun `duplicateUsingPOST with required fields`() {
		val res = createWithRequiredFields()
	...
	@Test
	fun `duplicateUsingPOST with all fields`() {
	...
	@Test
	fun `getByIdUsingGET16 with required fields`() {
		val res = createWithRequiredFields()
		val savedRes = repository.save(res)
	...
	@Test
	fun `getByIdUsingGET16 with all fields`() {
		val res = createWithAllFields()
		val savedRes = repository.save(res)
	...
	@Test
	fun `saveAllUsingPOST13 with required fields`() {
		val res = createWithRequiredFields()
		val result = super.create(url, res)
		val savedRes = repository.getById(findIdentityId(result))
		resourceAsserts(savedRes, result)
	...
	@Test
	fun `saveAllUsingPOST13 with all fields`() {
		val res = createWithAllFields()
		val result = super.create(url, res)
		val savedRes = repository.getById(findIdentityId(result))
		resourceAsserts(savedRes, result)
	...
	@Test
	fun `saveUsingPOST14 with required fields`() {
		val res = createWithRequiredFields()
		val result = super.create(url, res)
		val savedRes = repository.getById(findIdentityId(result))
		resourceAsserts(savedRes, result)
	...
	@Test
	fun `saveUsingPOST14 with all fields`() {
		val res = createWithAllFields()
		val result = super.create(url, res)
		val savedRes = repository.getById(findIdentityId(result))
		resourceAsserts(savedRes, result)
	...
	@Test
	fun `updateUsingPUT13 with required fields`() {
		val res = createWithRequiredFields()
		val savedRes = repository.save(res)
	...
	@Test
	fun `updateUsingPUT13 with all fields`() {
		val res = createWithAllFields()
		val savedRes = repository.save(res)
	...
	private fun resourceAsserts(savedResource: CatalogOfferLabel, result: MvcResult, index: Int = -1) {
	...
	private fun createWithRequiredFields(): CatalogOfferLabel {
	return CatalogOfferLabel(
	...
	private fun createWithAllFields(): CatalogOfferLabel {
		return CatalogOfferLabel(
				createdDate = java.sql.Timestamp(System.currentTimeMillis()),
